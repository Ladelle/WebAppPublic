...
<div class="content-wrapper">
    <div class="content">
        ...
        <div class="pure-g">
            <div class="l-box pure-u-1 pure-u-md-1-2 pure-u-lg-1-4">
                ...
                <p>
                    This program sends an email to the user after they have registered.
                </p>
            </div>
            <div class="l-box pure-u-1 pure-u-md-1-2 pure-u-lg-1-4">
                <h3 class="content-subhead">
            ...
            <div class="l-box pure-u-1 pure-u-md-1-2 pure-u-lg-1-4">
                ...
                <p>
                    This program shows all the users that have registered, can edit, delete and update information.
                </p>
            </div>
            <div class="l-box pure-u-1 pure-u-md-1-2 pure-u-lg-1-4">
                <h3 class="content-subhead">
                ...
                <p>
                    This program has the capabilities to log in users and log them out. 
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="ribbon l-box-lrg pure-g">
        ...
        <div class="pure-u-1 pure-u-md-1-2 pure-u-lg-3-5">
            ...
            <h2 class="content-head content-head-ribbon"><a style="color:white;" href ="https://docs.google.com/document/d/1lka6jCedCyDGU6x9Kj5MTc2T5s7tcYFGl4QmkJqMx2E/edit?usp=sharing">Link To My Report: Homework2 </a></h2>
            <p>
					This is the section that can link to the report for Homework 2.
            </p>
        </div>
    </div>
