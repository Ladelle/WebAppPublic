                    ...
                    <div class="pure-g">
                        <div class="l-box pure-u-1 pure-u-md-1-2 pure-u-lg-1-2">
                            <div class="pure-g">
                                ...
                                <div class="l-box pure-u-1 pure-u-md-3-4 pure-u-lg-3-4">
                                    <input type="text"class="flex-item form-control" value="<?php echo $p_details[0]['first_name']; ?>"  placeholder="Freda"  name="fname" id="fname" size="">
                                    <?php 
                        ...
                        <div class="l-box pure-u-1 pure-u-md-1-2 pure-u-lg-1-2">
                            <div class="pure-g">
                                ...
                                <div class="l-box pure-u-1 pure-u-md-3-4 pure-u-lg-3-4">
                                    <input type="text" class="flex-item form-control"  value="<?php echo $p_details[0]['last_name']; ?>" placeholder="Delrae"   name="lname" id="lname" size="">
                                    <?php 
